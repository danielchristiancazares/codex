...
mod tests {
    ...
    fn strengthen_contrast_chooses_the_safer_neutral_direction() {
        assert_eq!(
            [
                strengthen_contrast((180, 180, 180), (0, 0, 0), /*amount*/ 0.25),
                strengthen_contrast((80, 80, 80), (255, 255, 255), /*amount*/ 0.25),
                strengthen_contrast((255, 255, 255), (0, 0, 0), /*amount*/ 0.25),
            ],
    ...
    fn strengthen_contrast_never_reduces_the_original_ratio() {
        for (foreground, background) in [
            ...
            let strengthened = strengthen_contrast(foreground, background, /*amount*/ 0.35);
            assert!(
