...
//! - Rendering a single prompt-gutter caret for the active input or selected attachment.
...
//! Normal `R` enters Replace, where typed graphemes overwrite the suffix and Backspace restores
//! the most recently replaced grapheme. Insert uses a steady bar cursor; Normal and Replace defer
//! to the user's terminal cursor shape.
