...
impl ModelInfo {
    ...
    pub fn service_tier_for_request(&self, service_tier: ServiceTier) -> ServiceTier {
        crate::service_tier::resolve_request_service_tier(&self.service_tiers, service_tier)
    }
...
mod tests {
    ...
    fn service_tier_for_request_filters_unsupported_tiers() {
        ...
        assert_eq!(
            model.service_tier_for_request(ServiceTier::Flex),
            ServiceTier::Default
        );
        assert_eq!(
