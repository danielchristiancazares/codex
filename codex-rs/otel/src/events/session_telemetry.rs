...
impl SessionTelemetry {
    ...
    /// Records a text frame whose `type` was already decoded by the transport.
    ///
    /// Only timing events need the full JSON payload again; every other kind reuses the
    /// decoded discriminator without a second parse.
