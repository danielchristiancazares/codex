...
//!
//! Entry text uses approximate budgets. Labels are outside text caps, and tiny
//! budgets retain the irreducible omission marker. Before submission, consumers must
//! enforce the fork's 10K-token ceiling on each complete rendered item, including
//! all transcript pools, other sections, and serialization framing.
