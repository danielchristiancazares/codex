...
#[test]
fn reasoning_can_be_included_while_all_tool_output_shapes_are_excluded() {
    let history = [
        ResponseItem::FunctionCallOutput {
            id: None,
            call_id: Some("call-1".to_string()),
            name: None,
            namespace: None,
            output: FunctionCallOutputPayload::from_text("called output".to_string()),
            internal_chat_message_metadata_passthrough: None,
        },
        ResponseItem::FunctionCallOutput {
            id: None,
            ...
            namespace: None,
            output: FunctionCallOutputPayload::from_text("standalone output".to_string()),
            internal_chat_message_metadata_passthrough: None,
        },
        ...
        ResponseItem::Reasoning {
            ...
            encrypted_content: Some("private ciphertext".to_string()),
            internal_chat_message_metadata_passthrough: None,
        },
    ];
    let config = ConversationTranscriptConfig {
    ...
    assert_eq!(
        collect_transcript(&history, &config),
        vec![entry(
