...
#[test_case::test_case(TruncationPolicy::Tokens(1), 1; "token budget")]
#[test_case::test_case(TruncationPolicy::Bytes(401), 101; "byte budget converted to tokens")]
#[test_case::test_case(TruncationPolicy::Tokens(30_000), 10_000; "hard ceiling")]
