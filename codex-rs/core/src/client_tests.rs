...
#[path = "client_output_bounds_tests.rs"]
mod output_bounds;
    ...
    let output = client
        .compact_conversation_history(
            ...
            CompactConversationRequestSettings {
                effort: None,
                mode: codex_protocol::config_types::ReasoningMode::Standard,
...
#[test]
fn responses_metadata_includes_window_lineage_and_turn_metadata() {
    let parent_thread_id = ThreadId::new();
    ...
    let client_metadata = responses_metadata.client_metadata();
