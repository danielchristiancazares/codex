...
impl SessionConfiguration {
    ...
    pub(super) fn thread_config_snapshot(
        ...
        ThreadConfigSnapshot {
            ...
            service_tier: self.step_settings.service_tier,
            ...
            reasoning_mode: self.step_settings.reasoning_mode,
    ...
    pub(super) fn restorable_thread_settings(
        ...
        CodexThreadSettingsOverrides {
            ...
            reasoning_mode: codex_protocol::protocol::ReasoningModeUpdate::Set(
                self.step_settings.reasoning_mode,
            ),
        ...
        let session_result: anyhow::Result<Arc<Self>> = async {
            ...
            let events = std::iter::once(Event {
                ...
                msg: EventMsg::SessionConfigured(SessionConfiguredEvent {
                    ...
                    reasoning_mode: thread_config.reasoning_mode,
                    initial_messages,
                    rollout_path,
                }),
            })
